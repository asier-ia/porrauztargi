          ...
          {top2 && (
            ...
            >
              ...
              <p className="text-sm font-black text-slate-900 mt-1">
                {top2.points_total} <span className="text-[10px] font-bold text-slate-700">{t('ranking.pts')}</span>
              </p>
              {top2.prize > 0 && (
          ...
          {top1 && (
            ...
            >
              <div className="absolute -top-3 w-full flex justify-center">
                <span className="bg-white text-amber-600 text-[10px] font-black px-2.5 py-0.5 rounded-full shadow-md uppercase tracking-wider border border-amber-100">{t('ranking.leader')}</span>
              </div>
              ...
              <p className="text-lg font-black text-amber-950 mt-1 drop-shadow-sm">
                {top1.points_total} <span className="text-xs font-bold text-amber-900">{t('ranking.pts')}</span>
              </p>
              {top1.prize > 0 && (
          ...
          {top3 && (
            ...
            >
              ...
              <p className="text-sm font-black text-orange-950 mt-1">
                {top3.points_total} <span className="text-[10px] font-bold text-orange-900">{t('ranking.pts')}</span>
              </p>
              {top3.prize > 0 && (
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-shrink-0 ml-3">
                  ...
                  <div className="flex items-center gap-0.5">
                    ...
                    <span className="text-[10px] font-semibold text-emerald-500 uppercase">{t('ranking.pts')}</span>
                  </div>
                </div>
              </div>
            );
